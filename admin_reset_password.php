<?php
// ============================================================
// admin_reset_password.php  — Admin: Set new password via token
// ============================================================
session_start();
...
if (!$reset) {
    ...
    if (strlen($new) < 8) {
        ...
        logActivity('Reset password via email link', 'Auth');
...
<head>
  ...
  <title>Admin Reset Password — Barangay San Isidro</title>
