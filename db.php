...
function requireAdminLogin(): void {
    ...
    if (empty($_SESSION['admin_id'])) {
        if (function_exists('attemptAutoLogin') && attemptAutoLogin('admin')) {
            return; // auto-login via remember-me cookie succeeded
        }
...
function requireResidentLogin(): void {
    ...
    if (empty($_SESSION['resident_id'])) {
        if (function_exists('attemptAutoLogin') && attemptAutoLogin('resident')) {
            return; // auto-login via remember-me cookie succeeded
        }
